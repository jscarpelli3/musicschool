...
export function billingApprovalEmail(input: {
  ...
  const html = `<!doctype html><html><body style="margin:0;background:#171713;color:#e9e4d8;font-family:Arial,sans-serif"><div style="max-width:600px;margin:0 auto;padding:48px 24px"><p style="margin:0 0 32px;color:#b2a68f;font-size:12px;letter-spacing:.14em;text-transform:uppercase">${school}</p><h1 style="margin:0 0 24px;font-family:Georgia,serif;font-size:34px;font-weight:400;line-height:1.15">Review ${period} lesson charges</h1><p style="margin:0 0 16px;line-height:1.65">Hi ${payer},</p><p style="margin:0 0 28px;line-height:1.65">${school} has prepared an itemized total of <strong>${amount}</strong>.</p><a href="${url}" style="display:inline-block;border:1px solid #b89b68;color:#e9e4d8;padding:14px 22px;text-decoration:none">Review and approve&nbsp; →</a><p style="margin:30px 0 0;color:#b2a68f;font-size:13px;line-height:1.65">Approval does not charge your card. The school initiates payment separately after approval. This secure link expires in 72 hours.</p><div style="border-top:1px solid #4b473f;margin-top:40px;padding-top:20px;color:#817a6d;font-size:12px;line-height:1.6">If you did not expect this request, contact the school directly.</div></div></body></html>`;
