...
export const metadata: Metadata = { title: "SMS Terms · Common Time" };

export default function TermsPage() {
  return <main className="mx-auto min-h-screen max-w-3xl px-5 py-12 sm:px-8 sm:py-20">
    <p className="text-sm text-brand">Common Time</p><h1 className="mt-4 font-display text-5xl sm:text-7xl">SMS Terms of Service</h1><p className="mt-4 text-xs text-muted">Last updated August 9, 2026</p>
