...
import { InviteSchoolForm } from "./invite-school-form";
...
export default async function PlatformAdminPage(){
 ...
 return <main className="mx-auto min-h-screen max-w-7xl px-5 py-10 sm:px-8 sm:py-section">
  ...
  <section className="py-10 border-b border-line"><p className="text-xs uppercase tracking-[0.14em] text-brand">Private beta</p><h2 className="mt-2 font-display text-3xl">Invite a school</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-muted">Create a private, single-purpose signup link. It only works for the email address below and expires after 14 days.</p><InviteSchoolForm/></section>
