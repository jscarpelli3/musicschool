...
export default async function AppearancePage({
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-5 py-10 sm:px-8 sm:py-section">
      ...
      <nav aria-label="Appearance sections" className="flex gap-2 border-b border-line py-5">
        <a href="#colors" className="rounded-control border border-line px-4 py-2 text-sm text-ink transition hover:-translate-y-px hover:bg-surface">Colors</a>
        <a href="#fonts" className="rounded-control border border-line px-4 py-2 text-sm text-ink transition hover:-translate-y-px hover:bg-surface">Fonts</a>
      </nav>
      <section id="colors" className="grid scroll-mt-6 border-b border-line md:grid-cols-[1fr_2fr]">
      ...
      <section id="fonts" className="grid scroll-mt-6 border-b border-line md:grid-cols-[1fr_2fr]">
