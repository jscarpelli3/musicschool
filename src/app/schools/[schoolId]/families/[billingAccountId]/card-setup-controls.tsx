...
export function CardSetupControls({ schoolId, billingAccountId, disabled }: {
  ...
  return (
    <div className="border-t border-line pt-5">
      ...
      <p className="mt-3 max-w-xl text-xs leading-5 text-muted">Send this Stripe-hosted link to the payer. They enter their own card and phone number; MusicSchool never receives the card details.</p>
