...
export const metadata: Metadata = { title: "Privacy Policy · MusicSchool" };

export default function PrivacyPage() {
  return <PolicyPage title="Privacy Policy" updated="August 9, 2026">
    <p>MusicSchool provides scheduling, billing, and communication tools for music schools. This policy explains how MusicSchool handles information submitted through its transactional SMS program.</p>
    ...
    <h2>Sharing and processors</h2><p>Service providers such as communications, hosting, database, and payment processors may process information only to provide MusicSchool services. We do not sell mobile numbers or SMS consent data. All the above categories exclude text messaging originator opt-in data and consent; this information won’t be shared with any third parties.</p>
