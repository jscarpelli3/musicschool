...
export function AddTeacherDialog({ instruments, action, emptyMessage = "Choose school instruments in School Setup before adding staff.", triggerLabel = "Add teacher +" }: {
  instruments: string[];
  ...
  return <div>
    <FocusedModal triggerLabel={triggerLabel} eyebrow="Staff access" title="Add a teacher." description="Create their staff record and send passwordless access." disabled={instruments.length === 0} open={open} onOpenChange={setOpen}>
