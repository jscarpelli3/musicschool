...
begin
  ...
  if exists (select 1 from public.email_suppressions where recipient_email = prior_delivery.recipient_email) then raise exception 'recipient_suppressed'; end if;
