...
Capability conversion remains in progress for secondary setup/detail pages and their Server Actions. After that, structural follow-up is shared reason/status contracts and exhaustive calendar state descriptors.
