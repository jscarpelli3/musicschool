...
The generic delivery-registry structural item is complete. Structural follow-up remains capability-derived UI/actions, shared reason/status contracts, and exhaustive calendar state descriptors.
