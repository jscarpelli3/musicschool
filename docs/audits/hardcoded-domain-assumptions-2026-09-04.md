...
This closes high-priority item 5. The domain-flow blockers and high-priority corrections in this audit are now complete. Structural follow-up remains the generic delivery registry, capability-derived UI/actions, shared reason/status contracts, and exhaustive calendar state descriptors.
